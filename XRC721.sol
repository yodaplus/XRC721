...
// File: contracts/introspection/IXRC165.sol
...
// File: contracts/token/XRC721/IXRC721Receiver.sol
...
contract IXRC721Receiver {
  /**
     ...
     * after a {IXRC721-safeTransferFrom}. This function MUST return the function selector,
...
contract XRC165 is IXRC165 {
  /*
     ...
     */
  bytes4 private constant _INTERFACE_ID_XRC165 = 0x01ffc9a7;
  ...
  function _registerInterface(bytes4 interfaceId) internal {
    require(interfaceId != 0xffffffff, "XRC165: invalid interface id");
    _supportedInterfaces[interfaceId] = true;
  }
}

// File: contracts/token/XRC721/XRC721.sol

/**
 * @title ERC721 Non-Fungible Token Standard basic implementation
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract XRC721 is Context, XRC165, IXRC721 {
  using SafeMath for uint256;
  ...
  function _safeMint(address to, uint256 tokenId, bytes memory _data) internal {
    ...
    require(
      ...
      "XRC721: transfer to non XRC721Receiver implementer"
    );
  }
  ...
  /**
     * @dev Internal function to invoke {IXRC721Receiver-onERC721Received} on a target address.
    ...
    returns (bool)
  {
    ...
    bytes4 retval = IXRC721Receiver(to).onERC721Received(_msgSender(), from, tokenId, _data);
 ...
 * @dev See https://eips.ethereum.org/EIPS/eip-721
 */
contract XRC721Enumerable is Context, XRC165, XRC721, IXRC721Enumerable {
  ...
  /*
     ...
     */
  bytes4 private constant _INTERFACE_ID_XRC721_ENUMERABLE = 0x780e9d63;

  /**
     * @dev Constructor function.
     */
  constructor() public {
    // register the supported interface to conform to XRC721Enumerable via ERC165
    _registerInterface(_INTERFACE_ID_XRC721_ENUMERABLE);
  }
  ...
  function tokenOfOwnerByIndex(address owner, uint256 index) public view returns (uint256) {
    require(index < balanceOf(owner), "XRC721Enumerable: owner index out of bounds");
  ...
  /**
     ...
     */
  function tokenByIndex(uint256 index) public view returns (uint256) {
    require(index < totalSupply(), "XRC721Enumerable: global index out of bounds");
  ...
  /**
     * @dev Internal function to burn a specific token.
     * Reverts if the token does not exist.
     * Deprecated, use {XRC721-_burn} instead.
     * @param owner owner of the token to burn
     * @param tokenId uint256 ID of the token being burned
     */
  function _burn(address owner, uint256 tokenId) internal {
...
// File: contracts/token/XRC721/IXRC721Metadata.sol
...
contract XRC721Metadata is Context, XRC165, XRC721, IXRC721Metadata {
  // Token name
  ...
  /*
     ...
     */
  bytes4 private constant _INTERFACE_ID_XRC721_METADATA = 0x5b5e139f;
  ...
  constructor(string memory name, string memory symbol) public {
    ...
    // register the supported interfaces to conform to ERC721 via ERC165
    _registerInterface(_INTERFACE_ID_XRC721_METADATA);
  }
  ...
  /**
     ...
     */
  function _setTokenURI(uint256 tokenId, string calldata uri) external {
 ...
 */
contract XRC721Mintable is XRC721, MinterRole {
  /**
...
// File: contracts/token/ERC721/ERC721MintableFull.sol

contract XRC721MintableFull is XRC721Mintable, XRC721Full {
  constructor(string memory name, string memory symbol) public XRC721Full(name, symbol) {
    // solhint-disable-previous-line no-empty-blocks
  }
}